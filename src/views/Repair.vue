...
<!-- Section -->
    <section class="main">
      <header class="invert accent2">
        <h1>Our Repair and Restoration Services</h1>
      </header>
      <div class="row gtr-200">
        <div class="col-7 col-12-medium">
          <span class="image fit"><img src="images/cls/49433534276_a0015e47f5_o.jpg" alt="" /></span>
          <span class="image fit"><img src="images/cls/49471210098_50e66f7caf_o.jpg" alt="" /></span>
        </div>
      ...
      <div class="row gtr-200">
        ...
        <div class="col-8 col-12-medium">
          <span class="image fit"><img src="images/cls/49622415613_820c906c0b_o.jpg" alt="" /></span>
          <span class="image fit"><img src="images/cls/49657107738_473a1b8ba9_o.jpg" alt="" /></span>
        </div>
      </div>
      <hr>
      <div class="row gtr-200">
        <div class="col-8 col-12-medium">
          <span class="image fit"><img src="images/cls/20191227_112803.jpg" alt="" /></span>
        </div>
        <div class="col-4 col-12-medium">
          <h3>Walkways</h3>
